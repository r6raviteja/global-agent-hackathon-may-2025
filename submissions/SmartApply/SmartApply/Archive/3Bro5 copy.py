...
async def main():
    async with await browser.new_context() as context:
        ...
        tasks = [
            ...
            Call {cv_content} for answering any user experience or skills related questions, answer in 2-3 sentences. 
            ...
            For combofilling fields (writing and selecting dropdown) call 'Select location from dropdown' 
