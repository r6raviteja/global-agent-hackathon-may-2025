...
async def main():
    async with await browser.new_context() as context:
        ...
        tasks = [
            ...
            f"""
            Navigate to {job_url} and fill basic information.
            
            Steps:
            1. Load {job_url}
            2. Wait 2 seconds for page load
            3. Click 'Apply' if present
            4. Fill form fields using:
            {personal_details}
            ...
            call 'Upload a file directly without opening file picker' to:
            ...
            # Task 3: Location Fields
            f"""
            Handle all location dropdowns.
            
            Use 'Select location from dropdown' for:
            - City: {personal_details["City"]}
            - Country: {personal_details["Country"]}
            - State: {personal_details["State"]}
            
            Wait 3 seconds for each dropdown to load.
            """,

            # Task 4: Experience Questions
            f"""
            Answer experience-related questions.
            
            For any questions about experience or skills:
            Use 'Read file content from available file paths' with:
            - File path: {resume_path}
            
            Format answers based on resume content.
            """,

            # Task 5: Submit and Validate
            f"""
